...
const whatsappMessages = {
  generic:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre o meu caso.",
  healthPlan:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre um problema com plano de saúde.",
  insurance:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre um problema com seguro.",
  blockedAccount:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre uma conta profissional bloqueada.",
  bankingFraud:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre uma fraude ou questão bancária.",
  airline:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre um problema com companhia aérea.",
  digital:
    "Olá, vim pelo site da Dra. Gisele Gabriel e gostaria de falar com a equipe jurídica sobre um caso envolvendo ataques, exposição ou prejuízo à reputação na internet.",
};
...
const practiceAreas: PracticeArea[] = [
  {
    ...
    description:
      "Atuação jurídica em negativas de cobertura envolvendo tratamentos, cirurgias, exames, medicamentos, internações e home care.",
    items: [
  ...
  {
    title: "Seguros e seguradoras",
    description:
      "Atuação em questões envolvendo negativas de indenização ou cobertura, pagamento parcial, demora e análise da documentação do sinistro.",
    items: [
      "Seguro de vida",
      "Seguro de automóvel",
  ...
  {
    title: "Contas profissionais bloqueadas",
    description:
      "Atuação jurídica em casos envolvendo contas profissionais, comerciais e perfis relevantes para a atividade do titular, inclusive em plataformas digitais.",
    items: [
      "Instagram profissional",
      "Meta e perfis comerciais",
      "Uber e plataformas de trabalho",
      "Contas ligadas à atividade profissional",
    ],
    cta: "Falar com a equipe jurídica",
  ...
  {
    title: "Fraudes e questões bancárias",
    description:
      "Atuação em fraudes, operações não reconhecidas e outras situações bancárias que demandem avaliação jurídica dos fatos e documentos.",
    items: [
      "Pix e transferências",
      "Empréstimos não contratados",
      "Cartões e contas invadidas",
...
const serviceSteps = [
  {
    ...
    description:
      "Conte resumidamente a situação e informe os dados necessários para compreensão inicial do caso.",
  },
  {
    title: "Documentos e protocolos",
    description:
      "Apresente, quando solicitado, negativas, contratos, protocolos, prints, comprovantes e documentos relacionados.",
  },
  {
    title: "Avaliação jurídica",
    description:
      "Os fatos e documentos são avaliados para definição da viabilidade e das medidas juridicamente cabíveis.",
  },
  {
    title: "Definição da atuação",
    description:
      "Quando aplicável, são apresentadas as possibilidades de atuação judicial ou extrajudicial e as condições para continuidade do atendimento.",
  },
  {
    title: "Atuação jurídica",
    description:
      "Após a formalização da contratação, a atuação é conduzida conforme a estratégia jurídica definida para o caso.",
  },
];
...
const frequentlyAskedQuestions = [
  {
    ...
    answer:
      "Sim. O primeiro contato pode ser realizado pelo WhatsApp, permitindo o envio das informações necessárias para compreensão da situação.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "O primeiro contato é utilizado para reunir as informações necessárias à compreensão da situação. A prestação de serviços jurídicos depende da avaliação do caso e da formalização da contratação quando houver viabilidade e interesse das partes.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim. Durante o contato, a equipe poderá solicitar os documentos relevantes para compreender o caso.",
  },
  {
  ...
  {
    question: "Todo caso precisa de processo judicial?",
    answer:
      "Não. As medidas aplicáveis dependem dos fatos, documentos e da avaliação jurídica. Conforme o caso, a atuação pode envolver providências judiciais ou extrajudiciais.",
  },
  {
    question: "O envio de informações garante a contratação ou o resultado?",
    answer:
      "Não. O envio das informações não representa contratação automática, aceitação do caso ou garantia de resultado.",
  },
];
...
function WhatsAppButton({
  children = "Falar com a equipe jurídica",
  ...
  const trackingCta =
    typeof children === "string" ? children : "Falar com a equipe jurídica";
...
function Hero() {
  return (
    ...
    >
      ...
      />
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-4 pb-10 pt-8 sm:px-6 sm:py-12 lg:min-h-[calc(100svh-5.5rem)] lg:grid-cols-[1.2fr_0.8fr] lg:gap-12 lg:px-8 lg:py-16">
        <motion.div
        ...
        >
          <motion.p
            className="inline-flex max-w-full items-center gap-2 rounded-full border border-gold/30 bg-white px-3.5 py-2 text-[0.64rem] font-bold uppercase leading-5 tracking-[0.13em] text-navy shadow-sm sm:px-4 sm:text-[0.7rem] sm:tracking-[0.16em]"
            variants={fadeUp}
          >
            <Scale aria-hidden="true" size={15} className="text-gold" />
            Atuação jurídica em Direito da Saúde, Seguros, Direito Digital e do Consumidor
          </motion.p>
          <motion.h1
            className="mt-5 max-w-4xl text-balance font-serif text-[2.05rem] font-semibold leading-[1.06] text-navy sm:mt-7 sm:text-5xl lg:text-[3.4rem] xl:text-[3.65rem]"
            variants={fadeUp}
          >
            Advocacia para problemas com planos de saúde, seguros, bancos e contas profissionais bloqueadas
          </motion.h1>
          <motion.p
            className="mt-5 max-w-3xl text-pretty text-base leading-7 text-slate-650 sm:mt-6 sm:text-lg sm:leading-8"
            variants={fadeUp}
          >
            Cada situação é analisada com base nos fatos e documentos para
            definição das medidas judiciais ou extrajudiciais juridicamente
            cabíveis.
          </motion.p>
          <motion.div
          ...
          >
            <WhatsAppButton
              ariaLabel="Falar com a equipe jurídica pelo WhatsApp"
          ...
          <motion.div
            className="mt-6 grid max-w-3xl gap-2.5 text-sm font-semibold text-slate-600 sm:mt-7 sm:grid-cols-3"
            variants={fadeUp}
          >
            {[
              `${lawyer.name} · ${lawyer.oab}`,
              "Atendimento online em Goiás",
        ...
        <motion.div
          className="mx-auto w-full max-w-[24rem] lg:max-w-[27rem]"
...
function TrustSection() {
  const credentials = [
    {
      icon: Scale,
      title: "Inscrição profissional",
      text: lawyer.oab,
    },
    {
      icon: GraduationCap,
      title: "Formação",
      text: "Direito pela Universidade Federal de Goiás",
    },
    {
      icon: BriefcaseBusiness,
      title: "Experiência",
      text: "Atuação jurídica desde 2014",
    },
  ];
    ...
    >
      <div className="mx-auto grid max-w-7xl gap-3 md:grid-cols-3">
        {credentials.map((credential) => {
          ...
          return (
            <div
              className="flex items-center gap-3 rounded-xl border border-slate-200/80 bg-paper/55 px-4 py-3.5"
              key={credential.title}
            >
              <span className="grid size-10 shrink-0 place-items-center rounded-lg bg-navy text-gold-light">
...
function PracticeAreasSection() {
  const priorityAreas = practiceAreas.slice(0, 4);
  const airlineArea = practiceAreas[4];

  return (
    <section
      aria-label="Situações jurídicas em que atuamos"
    ...
    >
      <Reveal className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <p className="mt-4 text-balance font-serif text-3xl font-semibold leading-tight text-navy md:text-5xl">
          Situações jurídicas em que atuamos
        </p>
        <p className="mx-auto mt-5 max-w-2xl text-pretty text-base leading-8 text-slate-600 md:text-lg">
          Advocacia orientada pelos fatos e documentos de cada situação, com
          avaliação das providências judiciais ou extrajudiciais aplicáveis.
        </p>
      </Reveal>
      <motion.div
        className="mx-auto mt-12 grid max-w-7xl gap-5 px-4 sm:px-6 md:grid-cols-2 lg:px-8"
        initial="hidden"
        variants={stagger}
        ...
        {priorityAreas.map((area, index) => {
          ...
          return (
            ...
            >
              ...
              <h2 className="mt-6 font-serif text-2xl font-semibold text-navy md:text-3xl">
                {area.title}
              </h2>
      ...
      <Reveal className="mx-auto mt-6 max-w-7xl px-4 sm:px-6 lg:px-8">
        <article className="grid items-center gap-5 rounded-[1.35rem] border border-slate-200 bg-white p-5 shadow-[0_14px_42px_rgba(15,23,42,0.05)] md:grid-cols-[auto_1fr_auto] md:p-6">
          <span className="icon-box">
            <Plane aria-hidden="true" size={22} />
          </span>
          <div>
            <p className="text-[0.66rem] font-bold uppercase tracking-[0.18em] text-gold">
              Área complementar
            </p>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-600">
              {airlineArea.description}
            </p>
          </div>
          <WhatsAppButton
            ariaLabel="Falar com a equipe jurídica sobre companhias aéreas pelo WhatsApp"
            message={airlineArea.message}
            trackingArea={airlineArea.title}
            trackingLocation="area_complementar"
            variant="secondary"
          >
            Falar com a equipe jurídica
          </WhatsAppButton>
...
function HowItWorksSection() {
  return (
    ...
    >
      <SectionHeader
        eyebrow="Etapas da atuação"
        title="Como funciona a atuação jurídica"
        description="Da compreensão dos fatos à definição das medidas juridicamente cabíveis, cada etapa depende das particularidades do caso."
      />
      <motion.ol
      ...
      >
        {serviceSteps.map((step, index) => (
          <motion.li
            className="timeline-step relative content-start lg:min-h-72 lg:grid-cols-1 lg:items-start"
            key={step.title}
            variants={fadeUp}
          >
    ...
    <section className="section-padding scroll-mt-24 bg-white" id="sobre">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:px-8">
        ...
        <Reveal className="grid content-center gap-5 text-pretty text-lg leading-9 text-slate-600">
          <p>
            A Dra. Gisele Gabriel exerce advocacia na análise e condução de
            questões jurídicas que afetam a saúde, o patrimônio, a atividade
            profissional e os direitos do consumidor.
          </p>
          <p>
          ...
          <p>
            Quando juridicamente cabível, a atuação pode compreender medidas
            extrajudiciais, representação em processos e outras medidas
            judiciais adequadas à situação apresentada.
          </p>
        </Reveal>
      </div>
    </section>
      ...
      <Reveal className="mx-auto grid max-w-7xl gap-8 rounded-[1.65rem] border border-slate-200 bg-paper p-6 shadow-[0_18px_55px_rgba(15,23,42,0.055)] md:p-8 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <p className="mt-4 text-pretty text-base leading-8 text-slate-600">
            A atuação em Direito Digital também pode abranger exposição
            indevida, perfis falsos e ataques à reputação, conforme os fatos e
            documentos de cada situação.
          </p>
        </div>
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.78fr_1.22fr] lg:px-8">
        <Reveal>
          ...
          <p className="mt-5 text-pretty text-lg leading-8 text-slate-600">
            Use o formulário para apresentar os dados principais ou, se
            preferir, fale diretamente com a equipe jurídica pelo WhatsApp.
          </p>
          <div className="mt-8 grid gap-3 text-sm text-slate-600">
            {[
              "Campos objetivos para compreender a situação",
        ...
        <div className="relative grid items-center gap-8 lg:grid-cols-[1fr_auto]">
          <div>
            ...
            <h2 className="mt-3 text-balance font-serif text-3xl font-semibold md:text-5xl">
              Precisa tratar de uma dessas situações?
            </h2>
            <p className="mt-4 max-w-3xl text-pretty text-lg leading-8 text-slate-200">
              Entre em contato para apresentar as informações do caso e
              compreender as condições para avaliação e eventual atuação
              jurídica.
            </p>
          </div>
          <WhatsAppButton
            ...
            variant="light"
          >
            Falar com a equipe jurídica pelo WhatsApp
          </WhatsAppButton>
        </div>
      </Reveal>
    </section>
...
function MobileStickyCta({
  ...
  useEffect(() => {
    const targets = Array.from(document.querySelectorAll("#contato, footer"));
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        setIsObstructed(visibleTargets.size > 0);
      },
      { threshold: 0.01 },
    );
  ...
  return (
    <AnimatePresence initial={false}>
      {!isObstructed ? (
        <motion.div
          animate={{ opacity: 1, y: 0 }}
          className="pointer-events-none fixed inset-x-0 bottom-0 z-40 border-t border-white/70 bg-white/94 px-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-14px_38px_rgba(15,23,42,0.1)] backdrop-blur-xl sm:hidden"
          exit={{ opacity: 0, y: 16 }}
